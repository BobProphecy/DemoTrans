...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/INFA1_COMM_MDM_m_STG_PUB_PTY")
    registerUDFs(spark)
    
    MetricsCollector.instrument(spark = spark, pipelineId = "pipelines/INFA1_COMM_MDM_m_STG_PUB_PTY", config = Config)(
        pipeline
    )
