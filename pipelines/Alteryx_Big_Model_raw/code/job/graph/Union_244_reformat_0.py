...
def Union_244_reformat_0(spark: SparkSession, in0: DataFrame) -> DataFrame:
    return in0.select(
        ...
        col("isMatch").cast(BooleanType()).alias("isMatch"), 
        ...
        lit(None).cast(IntegerType()).alias("IsLastDayOfMonth"), 
        lit(None).cast(BooleanType()).alias("IsLastDayofQuarter")
    )
